...
public abstract class OSHEntities {
  ...
  public static <OSM extends OSMEntity> SortedMap<OSHDBTimestamp, OSM> getByTimestamps(
    ...
    while (itr.hasNext() && i >= 0) {
      ...
      if (osm.getTimestamp().getRawUnixTimestamp() > byTimestamps.get(i).getRawUnixTimestamp()) {
        ...
        while (i >= 0
            && osm.getTimestamp().getRawUnixTimestamp()
                <= byTimestamps.get(i).getRawUnixTimestamp()) {
  ...
  public static <OSM extends OSMEntity> OSM getByTimestamp(
      Iterable<OSM> versions, OSHDBTimestamp timestamp) {
    for (OSM osm : versions) {
  ...
  public static <OSM extends OSMEntity> List<OSM> getBetweenTimestamps(
      Iterable<OSM> versions, final OSHDBTimestamp t1, final OSHDBTimestamp t2) {
  ...
  public static List<OSHDBTimestamp> getModificationTimestamps(OSHEntity<? extends OSMEntity> osh) {
    if (osh instanceof OSHWay) return getModificationTimestamps((OSHWay) osh, true);
    if (osh instanceof OSHRelation) return getModificationTimestamps((OSHRelation) osh, true);
   ...
   * @return a list of timestamps where this entity has been modified
   */
  static List<OSHDBTimestamp> getModificationTimestamps(
      OSHEntity<? extends OSMEntity> osh, boolean recurse) {
    if (osh instanceof OSHWay) return getModificationTimestamps((OSHWay) osh, recurse);
    if (osh instanceof OSHRelation) return getModificationTimestamps((OSHRelation) osh, recurse);
    return getModificationTimestamps((OSHNode) osh, recurse);
  }

  static List<OSHDBTimestamp> getModificationTimestamps(
      OSHNode osh, @SuppressWarnings({"unused", "SameParameterValue"}) boolean recurse) {
   ...
   * @return a list of timestamps where this entity has been modified
   */
  public static List<OSHDBTimestamp> getModificationTimestamps(
      OSHEntity<? extends OSMEntity> osh,
   ...
   */
  public static List<OSHDBTimestamp> getModificationTimestamps(
      OSHEntity<? extends OSMEntity> osh, Predicate<OSMEntity> osmEntityFilter) {
    if (osh instanceof OSHWay) {
  ...
  static List<OSHDBTimestamp> getModificationTimestamps(
      OSHNode osh, Predicate<OSMEntity> osmEntityFilter) {
    List<OSHDBTimestamp> result = new ArrayList<>();
  ...
  static List<OSHDBTimestamp> getModificationTimestamps(
      OSHWay osh, Predicate<OSMEntity> osmEntityFilter) {
    return _getModificationTimestamps(osh, true, osmEntityFilter);
  }

  static List<OSHDBTimestamp> getModificationTimestamps(
      OSHRelation osh, Predicate<OSMEntity> osmEntityFilter) {
    return _getModificationTimestamps(osh, true, osmEntityFilter);
  }

  private static List<OSHDBTimestamp> _getModificationTimestamps(
      OSHWay osh, boolean recurse, Predicate<OSMEntity> osmEntityFilter) {
  ...
  private static List<OSHDBTimestamp> _getModificationTimestamps(
      OSHRelation osh, boolean recurse, Predicate<OSMEntity> osmEntityFilter) {
