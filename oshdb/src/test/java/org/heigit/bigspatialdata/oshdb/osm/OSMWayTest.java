...
public class OSMWayTest {
  ...
  public void testGetRefs() {
    ...
    OSMWay instance =
        new OSMWay(
            1L, 1, new OSHDBTimestamp(1L), 1L, 1, new int[] {}, new OSMMember[] {part, part});
  ...
  public void testToString() {
    ...
    instance =
        new OSMWay(
            1L, 1, new OSHDBTimestamp(1L), 1L, 1, new int[] {1, 1, 2, 2}, new OSMMember[] {});
  ...
  public void testCompareTo() {
    OSMMember part = new OSMMember(1L, OSMType.NODE, 1);
    OSMWay o =
        new OSMWay(1L, 1, new OSHDBTimestamp(1L), 1L, 1, new int[] {}, new OSMMember[] {part});
    OSMWay instance =
        new OSMWay(1L, 1, new OSHDBTimestamp(1L), 1L, 1, new int[] {}, new OSMMember[] {part});
    ...
    instance =
        new OSMWay(1L, 3, new OSHDBTimestamp(1L), 1L, 1, new int[] {}, new OSMMember[] {part});
    assertTrue(instance.compareTo(o) > 0);
  }
  ...
  public void testGetTags() {
    ...
    OSMWay instance =
        new OSMWay(
            1L, 1, new OSHDBTimestamp(1L), 1L, 1, new int[] {1, 1}, new OSMMember[] {part, part});
