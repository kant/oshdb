  ...
  public void test() throws IOException {
        ...
        OSHRelation.build(
            Arrays.asList( //
                new OSMRelation(
                    ...
                    new int[] {},
                    new OSMMember[] {
                      new OSMMember(100, OSMType.NODE, 0, null),
        ...
        OSHRelation.build(
            Arrays.asList( //
                new OSMRelation(
                    ...
                    new int[] {},
                    new OSMMember[] {
                      new OSMMember(200, OSMType.WAY, 1, null),
    ...
    GridOSHRelations hosmCell =
        GridOSHRelations.compact(
            cellId, cellLevel, baseId, 0, 0, 0, Arrays.asList(relation300, relation301));
