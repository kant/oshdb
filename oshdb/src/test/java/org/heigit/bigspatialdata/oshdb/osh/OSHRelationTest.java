...
public class OSHRelationTest {
      ...
      buildHOSMWay(
          Arrays.asList(
              new OSMWay(
                  ...
                  new int[] {1, 2},
                  new OSMMember[] {
                    new OSMMember(100, OSMType.NODE, 0), new OSMMember(102, OSMType.NODE, 0)
                  })),
  ...
  public void testGetNodes() {
    ...
    try {
      OSHRelation hrelation =
          OSHRelation.build(
              versions, Arrays.asList(node100, node102, node104), Collections.emptyList());
  ...
  public void testWithMissingNode() {
    ...
    try {
      OSHRelation hrelation =
          OSHRelation.build(versions, Arrays.asList(node100, node104), Collections.emptyList());
  ...
  public void testGetWays() {
    ...
    versions.add(
        new OSMRelation(
            ...
            new int[] {},
            new OSMMember[] {
              new OSMMember(200, OSMType.WAY, 0), new OSMMember(202, OSMType.WAY, 0)
            }));
  ...
  public void testCompact() {
    ...
    try {
      ...
      assertEquals(
          way.getNodes().get(0).getVersions().get(0).getLon(),
          way200.getNodes().get(0).getVersions().get(0).getLon());
  ...
  public void testGetModificationTimestamps() throws IOException {
    ...
    w1versions.add(
        new OSMWay(
            1,
            3,
            new OSHDBTimestamp(7l),
            4445l,
            23,
            new int[] {},
            new OSMMember[] {
              new OSMMember(123, OSMType.NODE, 0), new OSMMember(124, OSMType.NODE, 0)
            }));
    w1versions.add(
        new OSMWay(
            1,
            2,
            new OSHDBTimestamp(5l),
            4444l,
            23,
            new int[] {},
            new OSMMember[] {
    ...
    versions.add(
        new OSMRelation(
            1, -4, new OSHDBTimestamp(20l), 10004l, 1, new int[] {}, new OSMMember[] {}));
    versions.add(
        new OSMRelation(
            1,
            3,
            new OSHDBTimestamp(10l),
            10003l,
            1,
            new int[] {1, 1, 2, 2},
    ...
    versions.add(
        new OSMRelation(
            ...
            new OSMMember[] {new OSMMember(1, OSMType.WAY, 0)}));
    OSHRelation hrelation =
        OSHRelation.build(versions, Arrays.asList(hnode1, hnode2, hnode3), Arrays.asList(hway1));
    ...
    // timestamp 9 has to be missing because at the time, the way wasn't a member of the relation
    // anymore
    assertEquals(10l, tss.get(4).getRawUnixTimestamp());
    // timestamp 11 has to be missing because at the time, the node wasn't part of the way member of
  ...
  public void testGetModificationTimestampsWithFilter() throws IOException {
    ...
    versions.add(
        new OSMRelation(
            1, -4, new OSHDBTimestamp(6l), 10004l, 1, new int[] {}, new OSMMember[] {}));
    versions.add(
        new OSMRelation(
            1,
            3,
            ...
            1,
            new int[] {},
            new OSMMember[] {new OSMMember(123, OSMType.NODE, 0)}));
    versions.add(
        new OSMRelation(
            1,
            2,
            new OSHDBTimestamp(3l),
            10002l,
            1,
            new int[] {},
            new OSMMember[] {new OSMMember(123, OSMType.NODE, 1)}));
    ...
    List<OSHDBTimestamp> tss =
        OSHEntities.getModificationTimestamps(hrelation, entity -> entity.getVersion() != 2);
    assertNotNull(tss);
  ...
  public void testToString() throws IOException {
    ...
    OSHRelation instance =
        OSHRelation.build(
            versions, Arrays.asList(node100, node102, node104), Collections.emptyList());
    String expResult =
        "OSHRelation ID:300 Vmax:+1+ Creation:3333 BBox:(8.680973,49.409498),(8.680973,49.409498)";
