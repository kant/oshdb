...
public class StringToIdMappingImpl implements StringToIdMapping {
  ...
  public StringToIdMappingImpl(
      final Int2IntMap uniqueStrings,
      final Object2IntMap<String> nonUniqueStrings,
      ToIntFunction<String> hashFunction,
      long estimatedSize) {
  ...
  public int getId(final String key) {
    ...
    if (value == -1) value = nonUniqueStrings.getInt(key);
    return value;
  }
  ...
  public static StringToIdMappingImpl load(
      String stringToIdMapping, ToIntFunction<String> hashFunction)
