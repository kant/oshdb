...
public class TransformOSHWay extends OSHWay2 {
  ...
  public static TransformOSHWay build(
    ...
    return TransformOSHWay.instance(
  ...
  public static TransformOSHWay instance(
      final byte[] data,
      final int offset,
      final int length,
      final long baseId,
  ...
  public OSMMember getMember(long memId) {
    if (memId < 0) return new OSMMember(memId * -1, OSMType.NODE, -1);
    else {
