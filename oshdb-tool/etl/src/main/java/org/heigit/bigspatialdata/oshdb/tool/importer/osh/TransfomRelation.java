...
public class TransfomRelation extends OSHRelation2 {
  ...
  public static TransfomRelation build(
    ...
    return TransfomRelation.instance(
  ...
  public static TransfomRelation instance(
      final byte[] data,
      final int offset,
      final int length,
      final long baseId,
  ...
  public OSMMember getMember(long memId, int type, int role) {
    if (type < 0) return new OSMMember(memId, OSMType.fromInt(type * -1), role);
    else {
