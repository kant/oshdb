...
public class TagToIdMapperImpl implements TagToIdMapper {
  ...
  public TagToIdMapperImpl(
      final StringToIdMappingImpl keyToId, final StringToIdMappingImpl[] valueToId) {
  ...
  public static TagToIdMapperImpl load(String kvToIdMapping, ToIntFunction<String> hashFunction)
    ...
    try (DataInputStream in =
        new DataInputStream(new BufferedInputStream(new FileInputStream(kvToIdMapping)))) {
  ...
  public static TagToIdMapperImpl read(DataInput in, ToIntFunction<String> hashFunction)
      throws IOException {
  ...
  public long estimatedSize() {
    ...
    for (StringToIdMappingImpl value : valueToId) size += value.estimatedSize();
    return size;
  }
}
