...
public class DBH2Arg {
  @ParametersDelegate public CommonArgs common = new CommonArgs();

  @Parameter(
      names = {"-mn", "--min-nodes"},
      description = "minimum of nodes per grid cell",
      validateWith = PositiveInteger.class)
  public int minNodesPerGrid = 1000;

  @Parameter(
      names = {"-mw", "--min-ways"},
      description = "minimum of ways per grid cell",
      validateWith = PositiveInteger.class)
  public int minWaysPerGrid = 100;

  @Parameter(
      names = {"-mr", "--min-relations"},
      description = "minimum of relations per grid cell",
      validateWith = PositiveInteger.class)
  public int minRelationPerGrid = 10;

  @Parameter(
      names = {"--nodesWithTagsOnly"},
      description = "only nodes with tags in the nodes grid")
  public boolean onlyNodesWithTags = true;

  @Parameter(
      names = {"--withOutKeyTables"},
      description = "load also keytables in to h2 db")
  ...
  @Parameter(
      names = {"-z", "--maxZoom"},
      description = "maximal zoom level",
      validateWith = PositiveInteger.class,
      order = 2)
