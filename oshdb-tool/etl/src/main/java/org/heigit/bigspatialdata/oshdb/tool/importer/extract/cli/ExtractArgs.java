...
public class ExtractArgs {
  ...
  @ParametersDelegate public DistributableArgs distribute = new DistributableArgs();

  @Parameter(
      names = {"--pbf"},
      description = "path to pbf-File to import",
  ...
  @Parameter(
      names = {"--bbox"},
      description = "extract_region")
  public String bbox = "";

  @Parameter(
      names = {"--timevalidity_from"},
      description = "first valid timestamp in isodate format",
      required = true,
      validateWith = TimeValidity.class)
  public String timeValidityFrom; // cc-by-sa 2007-10-07

  @Parameter(
      names = {"--timevalidity_to"},
      description = "latest valid timestamp in isodate format",
      validateWith = TimeValidity.class)
