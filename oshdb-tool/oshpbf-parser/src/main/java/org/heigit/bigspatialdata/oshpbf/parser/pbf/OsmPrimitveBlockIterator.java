...
public class OsmPrimitveBlockIterator implements Iterator<Object> {
  ...
  public OsmPrimitveBlockIterator(
      long blockStartPosition, crosby.binary.Osmformat.PrimitiveBlock block, Set<OSMType> types) {
  ...
  public Entity next() {
    ...
    if (entityIterator.hasNext()) return entityIterator.next();
  ...
  private Iterator<Entity> parseRelations(List<crosby.binary.Osmformat.Relation> entities) {
    return new Iterator<Entity>() {
      ...
      public Entity next() {
        ...
        final CommonEntityData ced =
            getCommonEntityData(
                entity.getId(), entity.getInfo(), entity.getKeysList(), entity.getValsList());
      ...
      public Entity next() {
        ...
        final CommonEntityData ced =
            new CommonEntityData(
                ...
                uid,
                getString(userSid),
                tags.toArray(new TagText[tags.size()]));
  ...
  private CommonEntityData getCommonEntityData(
      final long id,
      final crosby.binary.Osmformat.Info info,
