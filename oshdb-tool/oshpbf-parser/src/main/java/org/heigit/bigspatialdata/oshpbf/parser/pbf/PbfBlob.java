 ...
 * "http://wiki.openstreetmap.org/wiki/PBF_Format#File_format">BlobHeader(header) and
 * Blob(content)</a>. In addition this class hold the position within the
 *
 * <p>inputstream for this block.
 *
 * @author rtroilo
 */
