...
public class TestOSMContributionGetContributorUserId {
  ...
  private final OSHEntity dummyOshEntity =
      OSHNode.build(
        ...
        new OSMContribution(
            new IterateAllEntry(
                ...
                new OSMNode(
                    1L,
                    -2,
                    new OSHDBTimestamp(122L),
                    2L,
                    7,
                    new int[] {},
                    0,
                    0), // negative version == isVisible = false
    ...
    OSMContribution c =
        new OSMContribution(
            new IterateAllEntry(
                new OSHDBTimestamp(123),
                new OSMWay(
                    1L, 1, new OSHDBTimestamp(123L), 1L, 7, new int[] {}, new OSMMember[] {}),
                null,
                dummyOshEntity,
                null,
                null,
  ...
  public void wayIndirect() throws Exception {
    ...
    OSMWay entity =
        new OSMWay(
            ...
            1,
            new int[] {},
            new OSMMember[] {new OSMMember(3, OSMType.NODE, 0, OSHNode.build(versions))});
    OSMContribution c =
        new OSMContribution(
            new IterateAllEntry(
                new OSHDBTimestamp(123),
  ...
  public void relationIndirectWay() throws Exception {
    ...
    versions.add(
        new OSMWay(3L, 3, new OSHDBTimestamp(125L), 4L, 8, new int[] {}, new OSMMember[] {}));
    versions.add(
        new OSMWay(3L, 2, new OSHDBTimestamp(123L), 3L, 7, new int[] {}, new OSMMember[] {}));
    versions.add(
        new OSMWay(3L, 1, new OSHDBTimestamp(121L), 2L, 6, new int[] {}, new OSMMember[] {}));
  ...
  public void relationIndirectWayNode() throws Exception {
    ...
    versions.add(
        new OSMWay(
            2L,
            1,
            new OSHDBTimestamp(120L),
            0L,
            2,
            new int[] {},
            new OSMMember[] {new OSMMember(3, OSMType.NODE, 0, OSHNode.build(nodeVersions))}));

    OSMRelation entity =
        new OSMRelation(
            1L,
            1,
            new OSHDBTimestamp(110L),
            1L,
            1,
            new int[] {},
            new OSMMember[] {
              new OSMMember(
                  ...
                  OSMType.WAY,
                  0,
                  OSHWay.build(versions, Collections.singletonList(OSHNode.build(nodeVersions))))
            });
    OSMContribution c =
        new OSMContribution(
            new IterateAllEntry(
