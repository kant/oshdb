 ...
 *
 * <p>For internal use to do faster aggregation during reduce operations.
 *
...
class PayloadWithWeight<X> implements Serializable {
  ...
  static PayloadWithWeight<Double> accumulator(PayloadWithWeight<Double> acc, WeightedValue cur) {
  ...
  static PayloadWithWeight<Double> combiner(
      PayloadWithWeight<Double> a, PayloadWithWeight<Double> b) {
