 ...
 *
 * <p>Some information about OSM entities is only soft-coded into their tags, for example if a
 * closed way should represent a polygon (e.g. a building) or just a (linestring) loop (e.g. a
 * roundabout). Similarly, some information needed to build geometries from multipolygon relations
 * is encoded into the relation members' roles.
 */
